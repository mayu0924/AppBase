...
final class DecodeFormatManager {
  ...
  static {
    PRODUCT_FORMATS = EnumSet.of(BarcodeFormat.UPC_A, //UPC标准码(通用商品)
                                 BarcodeFormat.UPC_E, //UPC缩短码(商品短码)
  ...
  static {
    ...
    FORMATS_FOR_MODE.put(Intents.Scan.PRODUCT_MODE, PRODUCT_FORMATS); // 一维码
    FORMATS_FOR_MODE.put(Intents.Scan.QR_CODE_MODE, QR_CODE_FORMATS);// 二维码
